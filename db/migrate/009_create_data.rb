class CreateData < ActiveRecord::Migration
  ...
  def self.down
    ...
    Deadline.update_all("created_by=NULL, updated_by=NULL")
    FinancialyearType.update_all("created_by=NULL, updated_by=NULL")
    JournalType.update_all("created_by=NULL, updated_by=NULL")
